...
export const loadDataLink = createAction(
  '[Hydrator Effects] load data via link',
  props<{ params: any }>(),
);
export const loadDataLinkSuccess = createAction(
  '[Hydrator Effects] load data via link success',
  props<{
    uuid: string;
    network: Network;
...
export const loadDataLinkFailure = createAction(
  '[Hydrator Effects] load data via link failure',
  props<{ uuid: string; reason: NetworkIncompatibilityReasonEnum }>(),
);

export const loadData = createAction('[Home Component] load data', props<{ uuid: string }>());
