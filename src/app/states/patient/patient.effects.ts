...
import { setColumnGroupA, setColumnGroupB, setNoColumn } from '../nodes/nodes.actions';
...
export class PatientEffects {
  setPatientSelection$ = createEffect(() => {
    return this.actions$.pipe(
      ofType(setColumnGroupA, setColumnGroupB, resetPatientA, resetPatientB, setNoColumn),
