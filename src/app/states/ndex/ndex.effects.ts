...
import { SearchErrorTypeEnum } from '../../data/enum/search-error-type.enum';
import { NetworkSearchItem } from '../../data/schema/network-search-item';
import { NetworkSearch } from '../../data/schema/network-search';
import { ApiErrorTypeEnum } from '../../data/enum/api-error-type.enum';
...
import { selectMrsnvState } from '../aspect/aspect.selectors';
import { downloadCxFile } from '../aspect/aspect.actions';
