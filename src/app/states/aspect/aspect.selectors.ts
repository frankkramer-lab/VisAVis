...
export const selectLabelGroups = createSelector(
  selectMrsnvState,
  (state: FormGroupState<AspectState>) => state.value.networkAttributes.groups.label ?? 'Groups',
);
...
export const selectLabelSubtypes = createSelector(
  selectMrsnvState,
  () => 'Subtypes',
  // (states: FormGroupState<AspectState>) => states.value.networkAttributes.subtypes.label ?? 'Subtypes',
);
...
export const selectAllProperties = createSelector(
  ...
  (state: FormGroupState<AspectState>) => {
    ...
    const s: AspectState = state.value;
...
export const selectCandidatesSubnetworks = createSelector(
  ...
  (state: FormGroupState<AspectState>) => {
    if (
      ...
      return [];
    // return states.value.candidatesNetworkAttributes.subnetworks;
...
export const selectCandidatesGroups = createSelector(
  ...
  (state: FormGroupState<AspectState>) => {
    ...
    // return states.value.candidatesNetworkAttributes.groups;
...
export const selectCandidateGeneral = createSelector(
  selectMrsnvState,
  (state: FormGroupState<AspectState>) => state.value.candidateGeneral,
);
export const selectCandidateIndividual = createSelector(
  selectMrsnvState,
  (state: FormGroupState<AspectState>) => state.value.candidateIndividual,
);

export const selectCanExitView = createSelector(selectMrsnvState, (state: FormGroupState<AspectState>) => state.value.canExitView);
