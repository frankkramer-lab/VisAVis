...
export const selectActiveNav = createSelector(selectState, (state: HomeState) => state.activeNav);
export const selectIsCompatibilityCheckInProgress = createSelector(
  selectState,
  (state: HomeState) => state.checkCompatibilityInProgress,
);
