...
import { selectMarkedNodes } from '../../../states/nodes/nodes.selectors';
import {
...
import {
  ...
  selectUrl,
} from '../../../states/generator/generator.selectors';
import {
  copyToClipboard,
...
} from '../../../states/generator/generator.actions';
...
import { selectRelevantThresholds } from '../../../states/threshold/threshold.selectors';
import { selectLabelSubnetworks } from '../../../states/aspect/aspect.selectors';
...
export class SidebarGeneratorComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.subnetLabel$ = this.store.select(selectLabelSubnetworks);
