...
export class SidebarDownloadFormComponent {
  ...
  downloadForm: UntypedFormGroup = new UntypedFormGroup({
    extension: new UntypedFormControl('PNG'),
    scale: new UntypedFormControl(1, [Validators.required, Validators.min(1), Validators.max(10)]),
    transparent: new UntypedFormControl(false),
  });
